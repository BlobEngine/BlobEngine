...
struct SpringSystem {
  ...
  void UpdatePerMesh(Shape &shape, Spring &spring);

  void InitPerVertex(Shape &shape, Spring &spring);
  void UpdatePerVertex(Shape &shape,Spring &spring);

  void InitRadialCenter(Shape &shape, Spring &spring);
  void UpdateRadialCenter(Shape& shape, Spring& spring);

  void InitCircularCenter(Shape &shape, Spring &spring);
  void UpdateCircularCenter(Shape &shape, Spring &spring);
