...
void Editor::DebugMenu::Init() {
  ...
  ImGui::Begin("Debug Menu Properties", nullptr,
...
void Editor::DebugMenu::WorldSetup(int &maxpointvalue) {
  ...
  if (ImGui::CollapsingHeader("World")) {
...

    {
      ...
      ImGui::PushStyleColor(ImGuiCol_Button,
                            IM_COL32(128, 32, 32, 255)); // Dark red
...

    {
      ...
      ImGui::SameLine();
      ImGui::PushStyleColor(ImGuiCol_Button,
                            IM_COL32(32, 128, 32, 255)); // Dark green
    ...
    ImGui::InputInt("MaxPoint", &maxpointvalue, 0, 0);
...
void Editor::DebugMenu::Draw(SpringSystem &springs, int &maxpointval) {

  Init();
  WorldSetup(maxpointval);
  PointSetup(springs);
  SpringSetup(springs);
  Apply(springs);
}
