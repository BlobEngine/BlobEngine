...
int main() {
	...
	// Simulation objects
	Shape shape;
	int maxPointValue = shape.maxPoints; // Variable used as parameter to debugmenu and to update
	...
	//springSystem.InitPerVertex(shape, spring);
	//springSystem.InitPerMesh(shape, spring);
	//springSystem.InitRadialCenter(shape, spring);
	//springSystem.InitCircularCenter(shape, spring);
